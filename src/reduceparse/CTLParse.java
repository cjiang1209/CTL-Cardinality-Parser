...
public class CTLParse {
	public static void main(String[] args) {
		...
		System.out.println("GOT IT HERE. BS");
	...
	public static ArrayList<Property> getCTL(String filename,PetriModel64 theModel ) {
		SAXParserFactory saxParserFactory = SAXParserFactory.newInstance();
		...
		try {
			...
			// handler.trans = new ArrayList<PetriTransition>();
			//handler.arcs = new ArrayList<>();
			System.out.println("READY TO PARSE. BS");
			saxParser.parse(new File(filename), handler);
			//return new PetriModel64(handler.places, handler.trans, handler.arcs);
		} catch (ParserConfigurationException e) {
			e.printStackTrace();
     ...
     */
    public static void writeSmart64(PetriModel64 theModel, ArrayList<Property> theProperties, String infile, String outfile) {
