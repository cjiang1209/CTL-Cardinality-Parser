 ...
 * @author Ben
 */
public class DeadHandler extends DefaultHandler {
	String tmpValue;
	String propertyID;
	public ArrayList<String> formula; // collection of place names
	int varNum;
	public ArrayList<TokenCountExpression> bounds;
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
		if (qName.equalsIgnoreCase("id")) {
			//System.out.println("ID: (FORMULA) is  " + tmpValue);
			propertyID = tmpValue;
		} else if (qName.equalsIgnoreCase("place")) {
			...
			TokenCountExpression tempExp = new TokenCountExpression(formula,theModel);
			tempExp.boundFormulaName = propertyID;
			tempExp.varID = "var" + varNum;
			varNum++;
			bounds.add(tempExp);
			//System.out.println(tempExp.smartOut());
			//System.out.println(tempExp.smartOutBottom());
